...
<head runat="server">
	<title>How to get an item using FindItemByPath method</title>
</head>
<body>
	<form id="form1" runat="server">
		<div>
			...
			<dx:ASPxTextBox ID="pathTextBox" runat="server" Width="170px" Text="0_0"
				HelpText="Input the group path. The path is the item indexes (from the group children level item to the sought-for item) separated by the '_' symbol.">
				<ValidationSettings>
					<RequiredField IsRequired="true" ErrorText="This field cannot be empty" />
					<RegularExpression ValidationExpression="(([0-9]+_)*)([0-9]+)" ErrorText="Incorrect path format" />
				</ValidationSettings>
			</dx:ASPxTextBox>
			<dx:ASPxButton ID="ASPxButton1" runat="server" Text="Set Current Date By Item Path" OnClick="ASPxButton1_Click" Width="208px"></dx:ASPxButton>
		</div>
	</form>
</body>
</html>